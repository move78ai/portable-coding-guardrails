...
Keep repo-specific commands, architecture rules, and local invariants here instead of in account-global custom instructions.

For non-trivial coding tasks:
1. Restate the task, constraints, and invariants before changing code.
2. Name assumptions, ambiguities, and the lowest-risk interpretation.
